...
const translations = {
  en: {
    ...
    noAccountBody: 'No account exists for this email.',
    ...
    female: 'Female',
    other: 'Other',
    firstLanguageQuestion: 'Is English your first language?',
    yes: 'Yes',
    no: 'No',
  ...
  fr: {
    ...
    noAccountBody: "Aucun compte n'existe pour cet e-mail.",
    ...
    female: 'Femme',
    other: 'Autre',
    firstLanguageQuestion: "L'anglais est-il votre langue maternelle ?",
    yes: 'Oui',
    no: 'Non',
      ...
      <Box mt={8} display="flex" flexDirection="column" alignItems="center" gap={2}>
          ...
          {(['en', 'fr'] as const).map((l) => (
            <Box
              ...
              sx={{
                ...
                p: '4px 8px',
                border: '2px solid',
                borderColor: lang === l ? '#1976d2' : 'transparent',
                transition: 'border-color 0.2s ease',
                userSelect: 'none',
                '&:hover': { borderColor: lang === l ? '#1976d2' : '#ccc' },
              }}
            >
              {l === 'en' ? '🇬🇧' : '🇫🇷'}
            </Box>
        ...
        <Box component="form" onSubmit={handleSubmit} width="100%" display="flex" flexDirection="column" gap={2}>
          {error && (
            <Alert severity="error">
              {error === 'No account found with this email' ? (
                <>
                  <AlertTitle>{t.noAccountTitle}</AlertTitle>
                  {t.noAccountBody}{' '}
                  <Button
                    size="small"
            ...
            <Box sx={{ pt: 3, pb: 1 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                <FormControl fullWidth>
                  <InputLabel sx={{ fontWeight: 500 }}>{t.nationality}</InputLabel>
                  <Select
                    value={nationality}
                ...
                <FormControl component="fieldset" fullWidth>
                  <FormLabel component="legend" sx={{ mb: 2, fontWeight: 600 }}>{t.gender}</FormLabel>
                  <Box sx={{ display: 'flex', gap: 2, justifyContent: 'space-around' }}>
                    <Box
                      onClick={() => setGender('male')}
                      sx={{
                        flex: 1, py: 2.5, px: 2, border: '2px solid',
                    ...
                    >
                      ...
                      <Typography sx={{ fontSize: '14px', fontWeight: gender === 'male' ? 600 : 400 }}>{t.male}</Typography>
                    </Box>
                    ...
                    >
                      <Box sx={{ fontSize: '32px', color: '#333', mb: 1 }}>♀</Box>
                      <Typography sx={{ fontSize: '14px', fontWeight: gender === 'female' ? 600 : 400 }}>{t.female}</Typography>
                    </Box>
                    ...
                    >
                      <Box sx={{ fontSize: '32px', color: '#333', mb: 1 }}>⊕</Box>
                      <Typography sx={{ fontSize: '14px', fontWeight: gender === 'other' ? 600 : 400 }}>{t.other}</Typography>
                    </Box>
                  </Box>
                </FormControl>

                <FormControl component="fieldset" fullWidth>
                  <FormLabel component="legend" sx={{ mb: 2, fontWeight: 600 }}>{t.firstLanguageQuestion}</FormLabel>
                  <ToggleButtonGroup
                    ...
                    sx={{
                      '& .MuiToggleButton-root': {
                        py: 1.5, fontWeight: 500, fontSize: '15px', transition: 'all 0.2s ease',
          ...
          <Button type="submit" variant="contained" fullWidth disabled={loading || (tab === 1 && (!nationality || !gender || firstLanguageEnglish === null || !age || parseInt(age) < 5 || parseInt(age) > 120))}>
            {tab === 0 ? t.loginButton : t.registerButton}
          </Button>
        </Box>
      </Box>
